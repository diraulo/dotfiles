...
(setq user-full-name "Raoul Diffouo"
      user-mail-address "diraulo@hey.com")
...
;; Configure LSP mode
;; Will revisit setup of lsp-mode in future
...
;;   (elixir-mode . lsp)
;;   :init
;;   (add-to-list 'exec-path "~/Developer/core/elixir/elixir-lsp"))
